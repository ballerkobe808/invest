...
function betweenStrings(mainString, firstString, secondString) {
  ...
  var betweenString = mainString.substring(mainString.lastIndexOf(firstString) + firstLength, mainString.lastIndexOf(secondString));
...
let urlList = [
  'http://www.noradarealestate.com/Real-Estate-Investments/Georgia/Atlanta/',
